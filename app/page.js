...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <Script id="breadcrumbList" type="application/ld+json" strategy="beforeInteractive"
            ...
            <div className="row">
              <div className="col-lg-8 col-12">
                <p className="lead fs-6 my-4">
                  ...
                  site with top-tier web design, web development, or SEO
                  services.
                </p>
                <p className="lead fs-6 my-4">
                  Look no further! I specialize in optimizing websites for
                  superior placement on Search Engine Results Pages (SERPs) with
                  sleek, lightweight designs that will elevate your business
                  among clients. Let's delve into how I can transform your
                  online presence for success.
                </p>
                <p className="lead fs-6 my-4">
            ...
            <div className="row">
              <div className="col-lg-6 col-12 p-4">
                ...
                <p className="lead fs-6 my-5">
                  Discover exceptional web design services tailored to your
                  needs. From captivating graphics to intuitive User Interface
                  (UI) and User Experience (UX) design, I create websites that
                  resonate with your audience. Embracing responsive design, your
                  site will seamlessly adapt to any device, ensuring swift
                  loading times that swiftly introduce your business and its
              ...
              <div className="col-lg-6 col-12 p-4 bg-light border rounded">
                ...
                <p className="lead fs-6 my-5">
                  ...
                  businesses aiming to connect with a global audience to sell
                  your products or your services as a Brand. I specialize in
                  developing websites that not only showcase your products but
                  also facilitate outreach to audiences across smartphones and
              ...
              <div className="col-lg-6 col-12 p-4 bg-light border rounded">
                ...
                <p className="lead fs-6 my-5">
                  Think of SEO as the essential wheels for your digital
                  presence. Search Engine Optimization (SEO) is a pivotal aspect
                  of website design and development, prioritized for boosting
                  visibility once your site goes live. In today's era of digital
                  marketing, SEO stands as the most effective strategy for
                  promoting services and products, ensuring your business
                  thrives in the online realm.
                </p>
                <a
                  className="text-uppercase  btn btn-outline-dark me-2 px-4 py-2 mb-5"
                  href="services/website-seo"
                ...
                <div className="col-md-7 col-12">
                  <div className="py-5">
                    ...
                    <p className="lead fs-6 my-5">
                      ...
                      email. I'm here to provide swift solutions that propel
                      your business forward. Let's create something exceptional
                      together!
                    </p>
                    <nav className="nav">
                      <a
