                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <ul className="nav rounded bg-white link-anupam p-4">
                                            ...
                                            <li className="nav-item">
                                                <Link className="nav-link p-2" href="https://www.facebook.com/anupammondal.in/" target="_blank" title="Web Developer Anupam Mondal on Facebook">
                                                    <i className="bi bi-facebook fs-2"></i>
                                                </Link>
                                            </li>
                                            <li className="nav-item">
                                                <Link className="nav-link p-2" href="https://goo.gl/maps/oBwMFuFssGzWz6m26" target="_blank" title="Web Designer Developer Anupam Mondal | Google Business Profile">
                                                    <i className="bi bi-google fs-2"></i>
                                                </Link>
                                            </li>
                                            <li className="nav-item">
                                                <Link className="nav-link p-2" href="https://youtube.com/@anupamschannel?si=NIpojPBkv_ls5y1J" target="_blank" title="Anupam Mondal on YouTube | @anupamschannel">
                                                    <i className="bi bi-youtube fs-2"></i>
                                                </Link>
                                            </li>
                                            {/* <li className="nav-item">
                                                <Link className="nav-link p-2" href="https://anupammondal.business.site/"
                                                    target="_blank">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                        fill="currentColor" className="bi bi-globe-central-south-asia"
                                                        viewBox="0 0 16 16">
                                                        <path
                                            ...
                                            <li className="nav-item">
                                                <Link className="nav-link p-2" href="https://dribbble.com/anupammo" target="_blank">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                        fill="currentColor" className="bi bi-dribbble" viewBox="0 0 16 16">
                                            ...
                                            <li className="nav-item">
                                                <Link className="nav-link p-2" href="https://github.com/anupammo" target="_blank">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                            ...
                                            <li className="nav-item">
                                                <Link className="nav-link p-2" href="https://www.instagram.com/anupammondal.in"
                                                    target="_blank">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
